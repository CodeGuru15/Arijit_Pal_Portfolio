const GoldBar = () => {
  return (
    <>
      <div className="absolute top-0 right-0 w-[120vw] rotate-45 border-t-2 border-gold aspect-square">
        <div className=" animate-[slide_5s_linear_infinite] shadow-custom shadow-gold border-b-2 border-gold"></div>
      </div>
      <div className="absolute left-[-5%] w-[120vw] border-b-2 -rotate-12 top-32 border-gold">
      ...
      <div className="absolute left-[-20%] top-[90%] w-[100%] border-b-2 rotate-[30deg] border-gold">
        <div className="w-[20%] animate-[slide_4s_linear_infinite] shadow-custom shadow-gold border-b-2 border-gold"></div>
      </div>
    </>
  );
